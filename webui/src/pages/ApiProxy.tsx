...
export default function ApiProxy() {
    ...
    const loadCustomPresets = () => {
        try {
            const saved = localStorage.getItem('kiro_tools_custom_presets');
            if (saved) {
    ...
    const saveCustomPresetsToStorage = (presets: CustomPreset[]) => {
        try {
            localStorage.setItem('kiro_tools_custom_presets', JSON.stringify(presets));
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            if (enabled) {
                                                ...
                                                const restoredValue = appConfig.proxy.saved_user_agent || 'kiro/1.15.8 darwin/arm64';
                                                updateProxyConfig({
                                            ...
                                            <div className="flex items-center gap-2 w-full sm:w-auto min-w-[200px] max-w-sm">
                                                <div className="relative flex-1">
                                                    <GroupedSelect
                                                        ...
                                                        options={[
                                                            { value: '', label: 'Default (claude-sonnet-4-5)', group: 'System' },
                        ...
                        <div className="bg-white dark:bg-base-100 rounded-xl shadow-sm border border-gray-100 dark:border-base-200 overflow-hidden">
                            <div className="p-3">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    {/* Anthropic Card */}
                                    <div
                                        className="p-3 rounded-xl border-2 border-purple-500 bg-purple-50/30 dark:bg-purple-900/10"
                                    >
                                        <div className="flex items-center justify-between mb-2">
