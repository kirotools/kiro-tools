...
interface AccountState {
    ...
    addAccount: (params: accountService.AddAccountParams) => Promise<void>;
...
export const useAccountStore = create<AccountState>((set, get) => ({
    ...
    addAccount: async (params: accountService.AddAccountParams) => {
        set({ loading: true, error: null });
        try {
            await accountService.addAccount(params);
