                        ...
                        <div className="flex items-center gap-1.5 flex-wrap">
                            ...
                            {account.quota?.subscription_tier && (() => {
                                ...
                                if (tier.includes('power')) {
                                    ...
                                    return (
                                        <span className="flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-gradient-to-r from-violet-600 to-purple-600 text-white text-[9px] font-bold shadow-sm">
                                            <Gem className="w-2.5 h-2.5 fill-current" />
                                            PRO+
                                        </span>
                                    );
